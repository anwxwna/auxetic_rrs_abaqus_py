...
AuxPattM.ImplicitDynamicsStep(initialInc=(1/omega)/50.0,maxInc=(1/omega)/50.0,maxNumInc=10000,minInc=0.000002, timePeriod=1/omega, name='Disp_step',previous='Initial',description='Apply Displacement at right boundary',nlgeom=ON)
...
r_assem=outAssem.nodeSets['DISP_SET_RIGHT']
