...
##DISPALCEMENT AT THE RIGHT BOUNDARY
right_disp=20
#inc=2*ln
...
for iter in range(len(theta_list)):
	...
	part_sketch_name='rrs'			#PART SKETCH NAME
    model_name='rrs'+repr(theta)	#MODEL NAME
    print(model_name)
    
	AuxPattM=mdb.Model(name=model_name)
    AuxPattM.ConstrainedSketch(name=part_sketch_name, sheetSize=20.0)
